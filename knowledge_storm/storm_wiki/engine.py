...
if __name__ == "__main__":
    ...
    args = STORMWikiRunnerArguments(
        output_dir="output",  # Specify your desired output directory
        max_conv_turn=3,
        max_perspective=3,
    ...
    # Create a mock retriever or any necessary mock objects
    mock_retriever = None  # Replace with actual retriever if needed

    # Initialize the STORMWikiRunner
    runner = STORMWikiRunner(args=args, lm_configs=lm_configs, rm=mock_retriever)

    # Define the topic and other parameters for testing
    topic = "Artificial Intelligence"
    ground_truth_url = "https://example.com/ai_article"
    callback_handler = BaseCallbackHandler()  # Use a real or mock callback handler
